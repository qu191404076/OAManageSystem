...
<body>
	...
	<div id="start" class="start">
		...
		<h2 style="margin: 0; padding: 0;">欢迎使用OA管理系统</h2>
		 -->
		 <img alt="欢迎使用OA管理系统" src="image/title.png" style="margin-left: auto; margin-right: auto; padding: auto;" class="img-responsive"/>
		<p style="margin-top: 10px; margin-left: auto; margin-right: auto;">
